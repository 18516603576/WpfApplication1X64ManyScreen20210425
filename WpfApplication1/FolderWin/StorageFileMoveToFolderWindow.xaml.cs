...
{
    /// <summary>
    /// StorageFileMoveToFolderWindow.xaml 的交互逻辑
    /// </summary>
    public partial class StorageFileMoveToFolderWindow : Window
    {
        ...
        public StorageFileMoveToFolderWindow(WrapPanel storageListWrap, List<StorageFile> list, List<Canvas> canvasList)
        {
            InitializeComponent();
