...
namespace WpfApplication1.ManageWin
{
    ...
    /// </summary>
    public partial class EditTurnPictureLinkToWindow : Window
    {
        ...
        private readonly TurnPictureImagesDto dto;
        private readonly Button linkBtn;
        ...
        private void Submit_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (FrameworkElement ele in mainGrid.Children)
            {
                ...
                foreach (TabItem tabItem in tabControl.Items)
                {
                    ...
                    if (linkToPageIdVal > 0)  isLink = true;
