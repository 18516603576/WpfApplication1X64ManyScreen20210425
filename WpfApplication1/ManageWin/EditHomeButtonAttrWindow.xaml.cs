...
{
    /// <summary>
    /// EditHomeButtonAttrWindow.xaml 的交互逻辑
    /// </summary>
    public partial class EditHomeButtonAttrWindow : Window
    {
        ...
        public EditHomeButtonAttrWindow(Editing editing, FrameworkElement currElement)
        {
            InitializeComponent();
        ...
        private void Submit_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            Button homeBtn = (Button)currElement;
            homeBtn.Width = currDControl.width;
            homeBtn.Height = currDControl.height;
            homeBtn.Margin = new Thickness(currDControl.left, currDControl.top, 0, 0);
            homeBtn.Opacity = currDControl.opacity / 100.0;
