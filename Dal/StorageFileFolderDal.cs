...
namespace Dal
{
    public class StorageFileFolderDal
    {
        /*
       * 获取子文件夹
       */
        ...
        {
            String sql = "select * from storageFileFolder where parentId=@parentId  order by idx asc";
            ...
            List<StorageFileFolder> list = DataToEntity<StorageFileFolder>.FillModel(dt);
            return list;
        }
        /*
         * 获取最后一个文件夹
        ...
        */
        ...
        {
            String sql = "delete from storageFileFolder where id=@id";
            SQLiteParameter[] parameters = {
                       new SQLiteParameter("@id", DbType.Int32,4)
                      };
