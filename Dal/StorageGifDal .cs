...
*/
        public List<StorageGif> getNextPage(int currPage, int pageSize, int folderId)
        {
            ...
            String sql = "select * from storageGif where folderId=@folderId order by id desc limit @start,@pageSize";
            SQLiteParameter[] parameters = {
            ...
            List<StorageGif> list = DataToEntity<StorageGif>.FillModel(dt);
            return list;
        }
        ...
        public List<StorageGif> getNextPage2(int currPage, int pageSize)
        {
            ...
            String sql = "select * from storageGif   order by id desc limit @start,@end";
        ...
        {
            String sql = "select * from storageGif where folderId=@folderId order by id desc";
            SQLiteParameter[] parameters = {
                       new SQLiteParameter("@folderId", DbType.Int32,4)
                      };
        ...
        {
            String sql = "delete from storageGif where id=@id";
            SQLiteParameter[] parameters = {
                       new SQLiteParameter("@id", DbType.Int32,4)
                      };
            parameters[0].Value = id;
        ...
        {
            String sql = "select count(*) from storageGif where folderId=@folderId";
